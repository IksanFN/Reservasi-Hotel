          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row mx-0">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title text-primary">Tambah Data Kamar</h5>
              ...
              <div class="row mx-0 my-3">
            		<div class="card">
                        ...
                        <div class="mb-3 row align-items-center">
                          ...
                          <div class="col-md-9">
                            <input type="text" name="tipe_kamar" class="form-control" placeholder="Masukkan tipe kamar">
                          </div>
                        </div>  
                        ...
                        <div class="mb-3 row align-items-center">
                          ...
                          <div class="col-md-9">
                            <input type="text" name="fasilitas_kamar" class="form-control" placeholder="Masukkan Fasilitas Kamar">
                          </div>
                        </div>
                        ...
                        <div class="mb-3 row align-items-center">
                          ...
                          <div class="col-md-9">
                            <input type="text" name="jumlah_kamar" class="form-control" placeholder="Masukkan jumlah kamar">
                          </div>
                        </div>
